...
\begin{tikzpicture}
  ...
  \node at (2.25, 4.25) {候选个体};
  \node at (7.75, 4.25) {被选个体};
  \draw [->, thick, blue] (4, 4.25) --node[above,blue!50]{选择} (6, 4.25);
  \draw [cyan, thick, rounded corners] (2, 0.5) rectangle (8, 2.5);
  \draw [cyan, thick] (7, 0.5) -- (7, 2.5);
  \node [above] at (4.5, 2.5){鱼缸/池};
  \node [above] at (7.5, 2.5){孵化器};
  \draw [blue, rounded corners, ->, thick] (2, 1.5)--(1.25, 1.5)--node[left,align=center,blue!50]{标记\\个体}(1.25, 3.5);
  \draw [blue, rounded corners, ->, thick] (8.75, 3.5)--node[right, align=center, blue!50]{孵化鱼卵}(8.75, 1.5)--(8,1.5);
  % tanks
  ...
  \node [align=center] at (5, -2.25) {标记\\个体};
  ...
  \node at (12.75, 4.25){扩繁};
  \draw [cyan, thick, rounded corners] (11.5,2) rectangle (14, 0);
  \node[align=center] at (12.75, 1){种苗\\生产};
  \draw [cyan, thick, rounded corners] (11.5, -1.5) rectangle (14, -3);
  \node at (12.75, -2.25){商品群};
  \draw [->,blue,thick](12.75, 3.5) --node[right,align=left, blue!50]{鱼卵\\/鱼苗}(12.75, 2);
  \draw [->,blue,thick](12.75, 0) -- (12.75, -1.5);
  % Connections between nucleus and production
  \draw [->,blue,thick](9.5,4.25)--node[above,align=center, blue!50]{鱼苗/\\种苗}(11.5,4.25);
  \draw [->,blue,thick](10.75,4.25)--node[right, blue!50]{鱼苗}(10.75,1)--(11.5,1);
\end{tikzpicture}
\end{document}
