...
\begin{tikzpicture}
  % The nucleus part
  \draw [help lines] (0,0) rectangle (10.5,6);
  \node at (5,5.5) {\large{The Nucleus Populations}};
  ...
  \draw [->, thick, blue] (4, 4.25) --node[above]{Selection} (6, 4.25);
  ...
  \draw [blue, rounded corners, ->, thick] (2, 1.5)--(1.25, 1.5)--node[left,align=center]{Tagged\\fish}(1.25, 3.5);
  \draw [blue, rounded corners, ->, thick] (8.75, 3.5)--node[right, align=center]{Families\\of\\fermented\\egs}(8.75, 1.5)--(8,1.5);
  % tanks
  ...
  \draw [help lines] (0.25, -0.25) rectangle (3.75, -4.25);
  ...
  % The challege block
  \draw [help lines] (6.25, -0.25) rectangle (9.75, -4.25);
  ...
  % The production part
  \draw [help lines] (11.25, 5.25) rectangle (14.25, -3.25);
  ...
  \draw [->,blue,thick](12.75, 3.5) --node[right,align=left]{Eggs\\/fry}(12.75, 2);
  \draw [->,blue,thick](12.75, 0) -- (12.75, -1.5);
  % Connections between nucleus and production
  \draw [->,blue,thick](9.5,4.25)--node[above,align=center]{Fry/\\Fingerings}(11.5,4.25);
  \draw [->,blue,thick](10.75,4.25)--node[right]{Fry}(10.75,1)--(11.5,1);
\end{tikzpicture}
\end{document}
